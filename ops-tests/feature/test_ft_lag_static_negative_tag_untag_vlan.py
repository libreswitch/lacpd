...
###############################################################################
# Name         test_ft_lag_static_negative_tag_untag_vlan.py
#
# Objective:   Verify if a static LAG can still communicate after the tag,
#              untag, tag process.
#
# Description: This test verifies that a static LAG can still connected
