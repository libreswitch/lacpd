...
###############################################################################
# Name         test_ft_lag_static_minimum_members.py
#
# Objective:   Verify that a static LAG of 2 members or less can be deleted.
#
# Description: Tests that a previously configured static link aggregation of
#              two, one, or zero members can be deleted.
#
