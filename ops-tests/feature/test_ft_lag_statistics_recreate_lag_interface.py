...
#
###############################################################################
# Name:        test_ft_lag_statistics_recreate_lag_interface.py
#
# Description: Tests that a recreating a static Link Aggregation will have its
#              statistics cleaned and replaced with the sum of the current
...
#                                        (3 links)
#
# Success Criteria:  PASS -> Statistics are cleaned after recreation and
#                            represent the sum of all current members
#
...
def test_ft_lag_statistics_recreate_lag_interface(topology, step):
    ...
    create_destroy_lags(sw1, sw_real_ports, step)
