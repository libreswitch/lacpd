...
###############################################################################
# Name         test_ft_lag_static_tagged_vlan.py
#
# Objective:   Verify if a static LAG with tagged vlan can be created.
#
# Description: This test verifies that a static LAG can be configured with
#              tagged vlan
#
...
def test_static_tagged_vlan(topology, step):
