...
#if 0
#define  LACP_AGGR_PARTNER_SYS_PRI_SET   (0x01)
#define  LACP_AGGR_PARTNER_SYS_ID_SET    (0x02)
#define  LACP_AGGR_INDIVIDUAL            (0x04)
#endif /* 0 */

//
// The  following defines are  used between vlan
// and lacp
//
#if 0
#define     LACP_LPORT_INDIVIDUAL                (0x01)

#define     LACP_LPORT_PASSIVE                   (0x02)
#define     LACP_LPORT_LONG_TIMEOUT              (0x04)
#endif // 0
...
// #define LACP_PORT_AGGREGATION_DEFAULT (INDIVIDUAL)
#define LACP_PORT_AGGREGATION_DEFAULT (AGGREGATABLE)

//*****************************************************************
// These are the flags used while setting the sport_parameters, i.e.
// LAG/aggregator/"smarttrunk" parameters.
//*****************************************************************
