...
/* AVL functions                                                             */
/*****************************************************************************/
extern void *nemo_avl_insert_or_find(nemo_avl_tree_t *, nemo_avl_node_t *);
extern void nemo_avl_delete(nemo_avl_tree_t *, nemo_avl_node_t *);
extern void *nemo_avl_find(nemo_avl_tree_t *, void *);
extern void *nemo_avl_find_or_find_next(nemo_avl_tree_t *, void *, int);
...
#define NEMO_AVL_IN_TREE(NODE)  (((NODE).l_height != -1) &&              \
                                 ((NODE).r_height != -1))
