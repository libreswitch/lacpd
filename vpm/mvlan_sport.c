                   ...
                   super_port_t **ppsport)
{
   ...
   /*
    * Now alloc the block for this vlan and initialize it
    */
...
mvlan_sport_delete_validate_generic(super_port_t  *psport)
{
    ...
    /*
     * if the superport has lacp params set then we cannot delete the
     * superport The parameters must be negated
     */
...
mvlan_destroy_sport(super_port_t *psport)
{
    ...
    /*
     * send the info to all the entities that need to be informed
     */
